...
<div class="about-company-form">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="upload-box" onclick="document.getElementById('company-image-input').click()">
                <input type="file" id="company-image-input" name="AboutCompany[imageFile]" accept="image/*" style="display: none;" onchange="previewCompanyImage(this)">
                <div id="company-image-preview" class="preview-container">
                    <?php if ($model->image): ?>
...
<script>
    function previewCompanyImage(input) {
        const preview = document.getElementById('company-image-preview');
