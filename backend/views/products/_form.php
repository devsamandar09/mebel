...
<div class="products-form" style="margin-top: 50px;">
    <div class="card">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="upload-box" onclick="document.getElementById('image-input').click()">
                        <input type="file" id="image-input" name="Products[imageFile]" accept="image/*" style="display: none;" onchange="previewImage(this)">
