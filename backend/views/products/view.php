...
$this->title = 'Mahsulot #' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Mahsulotlar', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>

<div class="products-view" style="margin-top: 30px;">
...
<style>
    ...
    .products-view .card-header .btn {
        margin-left: 5px;
    }

    .products-view .card-body {
        padding: 25px;
    }

    .products-view .detail-view th {
        width: 200px;
        background-color: #f8f9fa;
        font-weight: 600;
    }

    .products-view .detail-view td {
        background-color: #ffffff;
    }

    .products-view .shadow-sm {
