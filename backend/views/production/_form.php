...
<div class="production-form" style="margin-top: 50px;">
    <div class="card">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="upload-box" onclick="document.getElementById('image-input').click()">
                        <input type="file" id="image-input" name="Production[imageFile]" accept="image/*" style="display: none;" onchange="previewImage(this)">
                ...
                <div class="col-lg-6">
                    <label class="form-label"><b>Video yuklash</b></label>
                    <div class="upload-box" onclick="document.getElementById('video-input').click()">
                        <input type="file" id="video-input" name="Production[videoFile]" accept="video/*" style="display: none;" onchange="previewVideo(this)">
