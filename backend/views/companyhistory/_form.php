            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="upload-box" onclick="document.getElementById('image-input').click()">
                        <input type="file" id="image-input" name="CompanyHistory[imageFile]" accept="image/*" style="display: none;" onchange="previewImage(this)">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="upload-box" onclick="document.getElementById('video-input').click()">
                        <input type="file" id="video-input" name="CompanyHistory[videoFile]" accept="video/*" style="display: none;" onchange="previewVideo(this)">
