        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 order-md-2 order-3">
                <div class="about_content" data-aos="fade-right">
                    <h6>About Us</h6>
                    <h2>We Provide Best Interior Design Services</h2>
                    <h5 class="text-white">Molestias exceaturi sint ecaecati cua non provident similiue</h5>
                    <p>Dolores aet ruas molestias exceaturi sint ecaecati cupiditate non provident, similiue sunt in culpa qui officia deserunt mollitia animi facere omnis.</p>
